...
export default function ResearchCategories() {
  ...
  return (
      <PageTemplate title={t('Research Categories')} url="/legal-research/categories" actions={pageActions} breadcrumbs={breadcrumbs} noPadding>
          ...
          <CrudFormModal
              ...
              title={formMode === 'create' ? t('Add New Research Category') : t('Edit Research Category')}
              mode={formMode}
          />
              ...
              formConfig={{
                  fields: [
                      ...
                      { name: 'color', label: t('Color'), type: 'color' },
                      {
                          ...
                          type: 'text',
                          render: () => (
                              <div className="rounded-md border bg-gray-50 p-2">{currentItem?.practice_area?.name || t('No Practice Area')}</div>
                          ),
                      },
                      {
                          name: 'status',
