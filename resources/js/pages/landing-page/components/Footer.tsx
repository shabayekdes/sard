          ...
          <div className="grid lg:grid-cols-6 gap-8 sm:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 mb-8 leading-relaxed">
                {sectionData.description || 'Transforming professional networking with innovative digital business cards. Connect, share, and grow your network effortlessly.'}
              </p>
          ...
          <div className="border-t border-gray-800 py-8 sm:py-12">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-gray-400 mb-6">
                {sectionData.newsletter_subtitle || 'Join our newsletter for product updates and networking tips'}
              </p>
