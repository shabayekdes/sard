  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email Us',
      content: settings?.contact_email || 'support@advocate.com',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed font-medium">
            {sectionData?.subtitle || 'Have questions about advocate? We\'d love to hear from you. Send us a message and we\'ll respond as soon as possible.'}
          </p>
        </div>
