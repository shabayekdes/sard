...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    modalId?: string
    /** Merged with default close button classes (e.g. `left-4 right-auto` to put X on the left in LTR). */
    closeButtonClassName?: string
  }
>(({ className, children, modalId, closeButtonClassName, ...props }, ref) => {
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        onPointerDownOutside={(e) => {
          // Allow backdrop clicks to close modal
