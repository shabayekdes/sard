...
return [
    ...
    ['key' => 'AWS_SECRET_ACCESS_KEY', 'group' => 'storage', 'value' => config('services.aws.secret_access_key', '')],
    ['key' => 'AWS_DEFAULT_REGION', 'group' => 'storage', 'value' => config('services.aws.default_region', 'us-east-1')],
    ['key' => 'AWS_BUCKET', 'group' => 'storage', 'value' => config('services.aws.bucket', '')],
    ['key' => 'AWS_URL', 'group' => 'storage', 'value' => config('services.aws.url', '')],
    ['key' => 'AWS_ENDPOINT', 'group' => 'storage', 'value' => config('services.aws.endpoint', '')],
    ['key' => 'WASABI_ACCESS_KEY', 'group' => 'storage', 'value' => ''],
    ['key' => 'WASABI_SECRET_KEY', 'group' => 'storage', 'value' => ''],
    ['key' => 'WASABI_REGION', 'group' => 'storage', 'value' => 'us-east-1'],
    ...
    ['key' => 'DEFAULT_CURRENCY', 'group' => 'currency', 'value' => 'SAR'],
    ['key' => 'DECIMAL_SEPARATOR', 'group' => 'currency', 'value' => '.'],
    ['key' => 'THOUSANDS_SEPARATOR', 'group' => 'currency', 'value' => ','],
    ['key' => 'FLOAT_NUMBER', 'group' => 'currency', 'value' => true],
    ['key' => 'CURRENCY_SYMBOL_SPACE', 'group' => 'currency', 'value' => false],
    ['key' => 'CURRENCY_SYMBOL_POSITION', 'group' => 'currency', 'value' => 'before'],
