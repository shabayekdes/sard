...
class CaseController extends BaseController
{
    ...
    public function show(Request $request, CaseModel $case)
    {
        ...
        $referrals = CaseReferral::withPermissionCheck()
            ...
            ->orderBy('id', 'desc')
            ->paginate($request->referral_per_page ?? 10, ['*'], 'referral_page');
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate(array_merge([
            ...
            'case_category_id' => ['required', Rule::exists('case_categories', 'id')],
            'case_subcategory_id' => ['required', Rule::exists('case_categories', 'id')],
