 ...
 * 
 * Centralized constants for legal AI system prompts.
 * These prompts ensure factual accuracy and prevent hallucinations.
 * 
 * Usage:
 *   LegalPrompts::CASE_SUMMARIZATION
 *   LegalPrompts::DOCUMENT_SUMMARIZATION
 *   LegalPrompts::DRAFTING
 *   LegalPrompts::TIMELINE_EXTRACTION
 */
class LegalPrompts
{
    /**
     ...
     * 
     * Use for summarizing legal cases with emphasis on:
     * - Factual accuracy
     * - Missing information identification
     * - Bullet point format
     * - Document citations
     */
    public const CASE_SUMMARIZATION = "You are a legal assistant specializing in case analysis and summarization, with expertise in Saudi Arabian law and legal systems. Your role is to provide comprehensive, accurate case summaries based solely on the provided case information.
...
• LANGUAGE: If the input text is in Arabic, respond entirely in Arabic. If in English, respond in English. Match the language of the input automatically.
...
Your summary must be factual, accurate, and suitable for legal professionals to make informed decisions.";
     ...
     * 
     * Use for summarizing legal documents with emphasis on:
     * - Factual accuracy
     * - Document name citations
     * - Missing information identification
     * - Bullet point format
     */
    public const DOCUMENT_SUMMARIZATION = "You are a legal assistant specializing in document analysis and summarization, with expertise in Saudi Arabian law and legal systems. Your role is to provide accurate, concise summaries of legal documents without adding information not present in the source.
...
Your summary must be factual, accurate, and suitable for legal professionals to quickly understand the document's contents.";
    ...
    /**
     * Drafting Prompt (Email/Memo)
     * 
     * Use for drafting legal communications with emphasis on:
     * - Factual accuracy
     * - Document citations
     * - Missing information identification
     * - Bullet point format for clarity
     */
    public const DRAFTING = "You are a legal assistant specializing in drafting professional legal communications (emails, memos, letters), with expertise in Saudi Arabian law and legal systems. Your role is to create well-structured, accurate legal documents based solely on the provided information.
...
Your drafts must be professional, accurate, and suitable for use in legal practice. Never add information not explicitly provided.";
     ...
     * 
     * Use for extracting chronological information with emphasis on:
     * - Factual accuracy
     * - Missing date identification
     * - Document citations
     * - Chronological bullet point format
     */
    public const TIMELINE_EXTRACTION = "You are a legal assistant specializing in extracting and organizing chronological information from legal documents and case files, with expertise in Saudi Arabian law and legal systems. Your role is to create accurate timelines based solely on the provided information.
...
Your timeline must be factual, accurate, and useful for legal professionals to understand the sequence of events. Never infer or assume dates not explicitly stated.";
     ...
     * Get prompt by key
     * 
     * @param string $key Prompt key (case_summarization, document_summarization, drafting, timeline_extraction)
     * @return string
    ...
    {
        $prompts = [
            'case_summarization' => self::CASE_SUMMARIZATION,
            'document_summarization' => self::DOCUMENT_SUMMARIZATION,
            'drafting' => self::DRAFTING,
            'timeline_extraction' => self::TIMELINE_EXTRACTION,
        ];
